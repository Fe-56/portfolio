        ...
        <div class="info col-xl-6 col-lg-6 col-md-6 col-sm-6 text-sm-end text-center d-flex align-items-center justify-content-sm-end justify-content-center">
          <h6>
            <Icon.ExperienceIcon
              ...
              labelText={textConst.EXPERIENCES_DBS2_ROLE}
            />
            <br />
            <Icon.ExperienceIcon
              iconName="experience_location"
              labelText={textConst.EXPERIENCES_DBS2_LOCATION}
            />
            <br />
            <Icon.ExperienceIcon
              iconName="experience_timeline"
              labelText={textConst.EXPERIENCES_DBS2_TIMELINE}
            />
          </h6>
        </div>
      ...
      <div class="experience_title_and_info d-flex row">
        ...
        <div class="info col-xl-6 col-lg-6 col-md-6 col-sm-6 text-sm-end text-center d-flex align-items-center justify-content-sm-end justify-content-center">
          <h6>
            <Icon.ExperienceIcon
              iconName="experience_role"
              labelText={textConst.EXPERIENCES_MYEXPOPLACE_ROLE}
            />
            <br />
            <Icon.ExperienceIcon
              iconName="experience_location"
              labelText={textConst.EXPERIENCES_MYEXPOPLACE_LOCATION}
            />
            <br />
            <Icon.ExperienceIcon
              iconName="experience_timeline"
              labelText={textConst.EXPERIENCES_MYEXPOPLACE_TIMELINE}
            />
          </h6>
        </div>
        <div class="company_image col-xl-6 col-lg-6 col-md-6 col-sm-6 d-flex align-items-center justify-content-start">
          <img
            src={myexpoplace_logo}
            loading="lazy"
            alt="HDB logo"
            id="hdb_logo"
            class="company_logo"
    ...
    <div id="coffeespace" class="experience">
      <div class="experience_title_and_info d-flex row">
        ...
        <div class="company_image col-xl-6 col-lg-6 col-md-6 col-sm-6 d-flex align-items-center justify-content-sm-end justify-content-center">
          <img
            src={coffeespace_logo}
            loading="lazy"
            alt="CoffeeSpace logo"
            id="coffeespace_logo"
            class="company_logo"
          ></img>
        </div>
        <div class="info col-xl-6 col-lg-6 col-md-6 col-sm-6 text-sm-start d-flex align-items-center justify-content-sm-start justify-content-center">
          <h6>
            <Icon.ExperienceIcon
              iconName="experience_role"
              labelText={textConst.EXPERIENCES_COFFEESPACE_ROLE}
            />
            <br />
            <Icon.ExperienceIcon
              iconName="experience_location"
              labelText={textConst.EXPERIENCES_COFFEESPACE_LOCATION}
            />
            <br />
            <Icon.ExperienceIcon
              iconName="experience_timeline"
              labelText={textConst.EXPERIENCES_COFFEESPACE_TIMELINE}
            />
          </h6>
        </div>
      </div>
      ...
      <div class="experience_title_and_info d-flex row">
        ...
        <div class="info col-xl-6 col-lg-6 col-md-6 col-sm-6 text-sm-end text-center d-flex align-items-center justify-content-sm-end justify-content-center">
          <h6>
            <Icon.ExperienceIcon
              iconName="experience_role"
              labelText={textConst.EXPERIENCES_HDB_ROLE}
            />
            <br />
            <Icon.ExperienceIcon
              iconName="experience_location"
              labelText={textConst.EXPERIENCES_HDB_LOCATION}
            />
            <br />
            <Icon.ExperienceIcon
              iconName="experience_timeline"
              labelText={textConst.EXPERIENCES_HDB_TIMELINE}
            />
          </h6>
        </div>
        <div class="company_image col-xl-6 col-lg-6 col-md-6 col-sm-6 d-flex align-items-center justify-content-start">
      ...
      <div class="experience_title_and_info d-flex row">
        ...
        <div class="info col-xl-6 col-lg-6 col-md-6 col-sm-6 text-sm-start d-flex align-items-center justify-content-sm-start justify-content-center">
          <h6>
            <Icon.ExperienceIcon
              iconName="experience_role"
              labelText={textConst.EXPERIENCES_SMILETUTOR_ROLE}
            />
            <br />
            <Icon.ExperienceIcon
              iconName="experience_location"
              labelText={textConst.EXPERIENCES_SMILETUTOR_LOCATION}
            />
            <br />
            <Icon.ExperienceIcon
              iconName="experience_timeline"
              labelText={textConst.EXPERIENCES_SMILETUTOR_TIMELINE}
            />
          </h6>
        </div>
      </div>
      ...
      <div class="experience_title_and_info d-flex row">
        ...
        <div class="info col-xl-6 col-lg-6 col-md-6 col-sm-6 text-sm-start d-flex align-items-center justify-content-sm-start justify-content-center">
          <h6>
            <Icon.ExperienceIcon
              iconName="experience_role"
              labelText={textConst.EXPERIENCES_DBS_ROLE}
            />
            <br />
            <Icon.ExperienceIcon
              iconName="experience_location"
              labelText={textConst.EXPERIENCES_DBS_LOCATION}
            />
            <br />
            <Icon.ExperienceIcon
              iconName="experience_timeline"
              labelText={textConst.EXPERIENCES_DBS_TIMELINE}
            />
          </h6>
        </div>
      </div>
