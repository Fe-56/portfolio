...
const NavbarButtonsCollapsed = () => {
  return (
    <button
      ...
      data-bs-target="#navbar_buttons"
      aria-controls="navbar_buttons"
      aria-expanded="false"
  ...
  return (
    <li class="nav-item active">
      <a
        ...
        id="nav_projects"
        onClick={navbarFunctions.clickedProjects}
      >
  ...
  return (
    <li class="nav-item active">
      <a
        ...
        class="nav-link active"
        id="nav_skills"
        onClick={navbarFunctions.clickedSkills}
      >
  ...
  return (
    <li class="nav-item active">
      <a
        ...
        class="nav-link active"
        id="nav_experiences"
        onClick={navbarFunctions.clickedExperiences}
      >
  ...
  return (
    <li class="nav-item active">
      <a
        ...
        class="nav-link active"
        id="nav_hobbies"
        onClick={navbarFunctions.clickedHobbies}
      >
  ...
  return (
    <li class="nav-item active">
      <a
        ...
        class="nav-link active"
        id="nav_contact"
        onClick={navbarFunctions.clickedContact}
      >
