...
const NameAndPhoto = () => {
  return <div class="container-fluid" id="name_and_photo">
...
const AboutMe = () => {
  return <div id="about_me" class="about_section">
...
const Resume = () => {
  return <div id="resume" class="about_section">
...
const FindMe = () => {
  return <div id="find_me" class="about_section">
...
const FindMeGitHubButton = () => {
  return <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
