...
const Email = () => {
  return <div id="email" class="contact_section">
    <h3><u>{textConst.CONTACT_EMAIL_TITLE}</u></h3>
    <Icon.ContactLinkIcon contactType="email" />
  </div>
}

const LinkedIn = () => {
  return <div id="linkedin" class="contact_section">
    <h3><u>{textConst.CONTACT_LINKEDIN_TITLE}</u></h3>
    <Icon.ContactLinkIcon contactType="linkedin" />
  </div>
}

const Telegram = () => {
  return <div id="telegram" class="contact_section">
    <h3><u>{textConst.CONTACT_TELEGRAM_TITLE}</u></h3>
    <Icon.ContactLinkIcon contactType="telegram" />
  </div>
}

const Phone = () => {
  return <div id="phone" class="contact_section">
    <h3><u>{textConst.CONTACT_PHONE_TITLE}</u></h3>
    <Icon.ContactLinkIcon contactType="phone" />
  </div>
}

const Location = () => {
  return <div id="location" class="contact_section">
    <h3><u>{textConst.CONTACT_LOCATION_TITLE}</u></h3>
