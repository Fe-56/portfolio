        ...
        <div class="skills">
          ...
          <p class="text-center">
            <div class="hard_skills">
              ...
              <Icon.HardSkill skillName="typescript" />
              &nbsp;&nbsp;&nbsp;&nbsp;
              <Icon.HardSkill skillName="solidity" />
              &nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <div class="project_title_and_info">
        ...
        <div class="info text-center d-flex align-items-center justify-content-center">
          <h6>
            <Icon.ProjectIcon
              iconName="project_role"
              labelText={textConst.PROJECTS_LONELY_NO_LONGER_ROLE}
            />
            <br />
            <Icon.ProjectIcon
              iconName="project_type"
              labelText={textConst.PROJECTS_LONELY_NO_LONGER_PROJECT_TYPE}
            />
            <br />
            <Icon.ProjectIcon
              iconName="project_timeline"
              labelText={textConst.PROJECTS_LONELY_NO_LONGER_TIMELINE}
            />
            <br />
          </h6>
        </div>
      ...
      <div class="project_title_and_info">
        ...
        <div class="info text-center d-flex align-items-center justify-content-center">
          <h6>
            <Icon.ProjectIcon
              iconName="project_role"
              labelText={textConst.PROJECTS_ONLINE_HATE_SPEECH_DETECTION_ROLE}
            />
            <br />
            <Icon.ProjectIcon
              iconName="project_type"
              labelText={
                textConst.PROJECTS_ONLINE_HATE_SPEECH_DETECTION_PROJECT_TYPE
              }
            />
            <br />
            <Icon.ProjectIcon
              iconName="project_timeline"
              labelText={
                textConst.PROJECTS_ONLINE_HATE_SPEECH_DETECTION_TIMELINE
              }
            />
            <br />
          </h6>
      ...
      <div class="project_title_and_info">
        ...
        <div class="info text-center d-flex align-items-center justify-content-center">
          <h6>
            <Icon.ProjectIcon
              iconName="project_role"
              labelText={textConst.PROJECTS_TRANSFERCONNECT_ROLE}
            />
            <br />
            <Icon.ProjectIcon
              iconName="project_type"
              labelText={textConst.PROJECTS_TRANSFERCONNECT_PROJECT_TYPE}
            />
            <br />
            <Icon.ProjectIcon
              iconName="project_timeline"
              labelText={textConst.PROJECTS_TRANSFERCONNECT_TIMELINE}
            />
            <br />
          </h6>
        </div>
      ...
      <div class="project_title_and_info d-flex row">
        ...
        <div class="info col-xl-6 col-lg-6 col-md-6 col-sm-6 text-sm-end text-center d-flex align-items-center justify-content-sm-end justify-content-center">
          <h6>
            <Icon.ProjectIcon
              iconName="project_role"
              labelText={textConst.PROJECTS_GIGLET_ROLE}
            />
            <br />
            <Icon.ProjectIcon
              iconName="project_type"
              labelText={textConst.PROJECTS_GIGLET_PROJECT_TYPE}
            />
            <br />
            <Icon.ProjectIcon
              iconName="project_timeline"
              labelText={textConst.PROJECTS_GIGLET_TIMELINE}
            />
            <br />
          </h6>
        </div>
      ...
      <div class="project_title_and_info d-flex row">
        ...
        <div class="info col-xl-6 col-lg-6 col-md-6 col-sm-6 text-sm-start text-center d-flex align-items-center justify-content-sm-start justify-content-center">
          <h6>
            <Icon.ProjectIcon
              iconName="project_role"
              labelText={textConst.PROJECTS_WORDLE_ROLE}
            />
            <br />
            <Icon.ProjectIcon
              iconName="project_type"
              labelText={textConst.PROJECTS_WORDLE_PROJECT_TYPE}
            />
            <br />
            <Icon.ProjectIcon
              iconName="project_timeline"
              labelText={textConst.PROJECTS_WORDLE_TIMELINE}
            />
            <br />
          </h6>
        </div>
      ...
      <div class="project_title_and_info d-flex row">
        ...
        <div class="info col-xl-6 col-lg-6 col-md-6 col-sm-6 text-sm-end text-center d-flex align-items-center justify-content-sm-end justify-content-center">
          <h6>
            <Icon.ProjectIcon
              iconName="project_role"
              labelText={textConst.PROJECTS_FEAST_ROLE}
            />
            <br />
            <Icon.ProjectIcon
              iconName="project_type"
              labelText={textConst.PROJECTS_FEAST_PROJECT_TYPE}
            />
            <br />
            <Icon.ProjectIcon
              iconName="project_timeline"
              labelText={textConst.PROJECTS_FEAST_TIMELINE}
            />
            <br />
          </h6>
        </div>
  ...
  return (
    <div id="will_i_go_broke" class="project">
      <div class="project_title_and_info d-flex row">
        ...
        <div class="project_image col-xl-6 col-lg-6 col-md-6 col-sm-6 d-flex align-items-center justify-content-sm-start justify-content-center">
          <img
            src={will_i_go_broke_logo}
            loading="lazy"
            alt="Will I Go Broke logo"
            id="will_i_go_broke_logo"
            class="project_logo"
          ></img>
        </div>
        <div class="info col-xl-6 col-lg-6 col-md-6 col-sm-6 text-sm-start text-center d-flex align-items-center justify-content-sm-start justify-content-center">
          <h6>
            <Icon.ProjectIcon
              iconName="project_role"
              labelText={textConst.PROJECTS_WILL_I_GO_BROKE_ROLE}
            />
            <br />
            <Icon.ProjectIcon
              iconName="project_type"
              labelText={textConst.PROJECTS_WILL_I_GO_BROKE_PROJECT_TYPE}
            />
            <br />
            <Icon.ProjectIcon
              iconName="project_timeline"
              labelText={textConst.PROJECTS_WILL_I_GO_BROKE_TIMELINE}
            />
            <br />
          </h6>
        </div>
      ...
      <div class="project_title_and_info d-flex row">
        ...
        <div class="info col-xl-6 col-lg-6 col-md-6 col-sm-6 text-sm-end text-center d-flex align-items-center justify-content-sm-end justify-content-center">
          <h6>
            <Icon.ProjectIcon
              iconName="project_role"
              labelText={textConst.PROJECTS_POKEMON_BATTLE_ROLE}
            />
            <br />
            <Icon.ProjectIcon
              iconName="project_type"
              labelText={textConst.PROJECTS_POKEMON_BATTLE_PROJECT_TYPE}
            />
            <br />
            <Icon.ProjectIcon
              iconName="project_timeline"
              labelText={textConst.PROJECTS_POKEMON_BATTLE_TIMELINE}
            />
            <br />
          </h6>
        </div>
        <div class="project_image col-xl-6 col-lg-6 col-md-6 col-sm-6 d-flex align-items-center justify-content-sm-end justify-content-center">
          <img
            src={pokemon_battle_logo}
            loading="lazy"
            alt="Pokemon Battle logo"
            id="pokemon_battle_logo_logo"
            class="project_logo"
          ></img>
        </div>
      </div>
...
const ProjectLink = ({ projectName }) => {
  ...
  return (
    <a href={projectURL} target="_blank" class="project_link">
